...
sudo cp /vagrant/modules/monitoring/prometheus/prometheus.yml /etc/prometheus/
sudo cp /vagrant/modules/monitoring/prometheus/alerts.yml /etc/prometheus/
...
sudo cp /vagrant/modules/monitoring/alertmanager/config.yml /etc/alertmanager.yml
